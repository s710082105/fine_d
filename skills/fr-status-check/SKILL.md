...
- macOS / Linux: `python3 skills/fr-status-check/scripts/run.py --config-path .codex/fr-config.json`
- Windows: `py skills\\fr-status-check\\scripts\\run.py --config-path .codex\\fr-config.json`
