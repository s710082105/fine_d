...
it('renders required sync fields', async () => {
  ...
  expect(screen.getByLabelText('Sync Host')).toBeInTheDocument()
  expect(screen.getByLabelText('Sync Port')).toBeInTheDocument()
  expect(screen.getByLabelText('Sync Username')).toBeInTheDocument()
