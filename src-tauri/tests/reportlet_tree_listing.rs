...
#[test]
fn list_reportlet_entries_reads_nested_tree() {
    ...
    let entries = list_reportlet_entries_from_project_dir(project_dir.as_path())
    ...
    assert_eq!(entries[1].children[0].name, "report.cpt");
    assert_eq!(entries[1].children[0].path, "sales/report.cpt");
}
